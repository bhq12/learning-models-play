...
def gradient_descent_step_single_parameter(parameters, training_data_set, labels, parameter_index):
    ...
    for i in range(len(training_data_set)):
        ...
        hypothesis = perform_perceptron_hypothesis(parameters, data_point)
...
def perform_perceptron_hypothesis(parameters, data_point):
    theta_transposed_x = 0
    # Theta (transposed) times x (data)
    for i in range(len(parameters)):
        # print(f'parameters: ' + str(parameters))
        # print(f'data_point: ' + str(data_point))
        # print(f'i: ' + str(i))
        theta_transposed_x += parameters[i] * data_point[i]

    if theta_transposed_x >= 0:
        return 1
    else:
        return 0
...
def main():
    ...
    while True:
        ...
        print(f'parameters: {parameters}')
        print('-200 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, -200])))
        print('-50 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, -50])))
        print('1 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 1])))
        print('25 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 25])))

        print('35 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 35])))
        print('40 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 40])))
        print('45 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 45])))
        print('50 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 50])))
        print('55 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 55])))
        print('60 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 60])))
        print('65 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 65])))

        print('75 estimate: ' + str(perform_perceptron_hypothesis(parameters, [1, 75])))
